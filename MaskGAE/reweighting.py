...
lrbl = 270  # learning rate of balance  # 1.0
epochb = 10  # number of epochs to balance  # 20
epochs = 30  # number of total epochs to run  # 30
num_f = 1  # number of fourier spaces  # 1
decay_pow = 2 # value of pow for weight decay  # 2
presave_ratio = 0.9125  # the ratio for presaving features  # 0.9
lambdap_constant = 30  # weight decay for weight1  # 70.0
lambda_decay_rate = 0.9  # ratio of epoch for lambda to decay  # 1
min_lambda_times = 0.01  # number of global table levels  # 0.01
lambda_decay_epoch = 6  # number of epoch for lambda to decay  # 5
...
"""
cora:
0.8 20 30 1 2 0.999 0.01 0.5 0.01 5 1
citeseer:
0.8 20 30 1 2 0.999 0.01 0.05 0.01 5 1
pubmed:
0.8 20 30 1 2 0.999 0.01 0.01 0.01 5 1
photo:
3 20 30 1 2 0.99999999 10 0.9 0.01 10 1
computers:
0.5 20 30 1 2 0.999 5 0.9 0.01 5 1
ogbn-arxiv:
180 10 30 1 2 0.9125 30 0.9 0.01 5 1
"""
